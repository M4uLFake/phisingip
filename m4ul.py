...
''' + W)
	print ('\n' + G + '[>]' + C + ' Created By : ' + W + 'M4uL ~ St1nky')
	print (G + '[>]' + C + ' Version    : ' + W + ver + '\n')

def network():
	try:
		requests.get('https://github.com/', timeout = 5)
		print (G + '[+]' + C + ' Check Internet Lu Bujank' + W, end='')
		print (G + ' Working' + W + '\n')
	except requests.ConnectionError:
		print (R + '[!]' + C + ' Gak Ada Internet Cok ' + W)
		sys.exit()

def version():
	print (G + '[+]' + C + ' Checking For Phising IP  Updates...' + W, end='')
